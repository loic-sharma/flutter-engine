...
///
/// @deprecated     Use `FlutterSemanticsNode2` instead. Adding members to this
///                 struct breaks the ABI of `FlutterUpdateSemantics`.
typedef struct {
...
/// enum.
///
/// @deprecated     Use `FlutterSemanticsCustomAction2` instead. Adding members
///                 to this struct breaks the ABI of `FlutterUpdateSemantics`.
typedef struct {
...
typedef struct {
  ...
  /// call is made.
  ///
  /// @deprecated    Use `update_semantics_callback2` instead. If this
  ///                callback is provided, `update_semantics_callback2` and
  ///                `update_semantics_callback` must not be provided.
  ...
  ///
  /// @deprecated    Use `update_semantics_callback2` instead. If this
  ///                callback is provided, `update_semantics_callback2`,
  ///                `update_semantics_node_callback`, and
  ///                `update_semantics_custom_action_callback` must not be
  ///                provided.
  ...
  /// call is made.
  ///
  /// If this callback is provided, `update_semantics_callback`,
  /// `update_semantics_node_callback`, and
