...
static flutter::PlatformViewEmbedder::UpdateSemanticsCallback
CreateV1EmbedderSemanticsUpdateCallback(
...
static flutter::PlatformViewEmbedder::UpdateSemanticsCallback
CreateV2EmbedderSemanticsUpdateCallback(
...
// Create a callback to notify the embedder of semantic updates
// using the embedder callback 'update_semantics_callback2'.
static flutter::PlatformViewEmbedder::UpdateSemanticsCallback
CreateV3EmbedderSemanticsUpdateCallback(
...
CreateEmbedderSemanticsUpdateCallback(const FlutterProjectArgs* args,
  ...
  if (update_semantics_node_callback != nullptr ||
      update_semantics_custom_action_callback != nullptr) {
    return CreateV1EmbedderSemanticsUpdateCallback(
