...
class Rasterizer final : public SnapshotDelegate,
 ...
 public:
  ...
  using LayerTreeDiscardCallback = std::function<bool(int64_t, flutter::LayerTree&)>;
 ...
 private:
  ...
  static bool NoDiscard(int64_t view_id, const flutter::LayerTree& layer_tree) { return false; }
